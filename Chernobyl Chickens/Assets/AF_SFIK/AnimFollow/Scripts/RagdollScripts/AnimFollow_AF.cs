...
#region
	...
	//		Debug.Log("The script AnimFollow has set the fixedDeltaTime to " + fixedDeltaTime); // Remove this line if you don't need the "heads up"
		...
		{	
			...
			{
				slaveRigidTransform.rigidbody.useGravity = useGravity;
				slaveRigidTransform.rigidbody.angularDrag = angularDrag;
				slaveRigidTransform.rigidbody.drag = drag;
				slaveRigidTransform.rigidbody.maxAngularVelocity = maxAngularVelocity;
				i++;
			}
		}
